    ...
    public class Execute implements Runnable {
        ...
        public  void playIt(String s)
        {
            if(flag)
            {
                switch (s)
                {
                    case "a1":a1StreamId=soundPool.play(a1Id,1,1,1,0,1);
                        Log.d(log,a1StreamId+"a1");
                        break;
                    case "a1s":a1sStreamId=soundPool.play(a1sId,1,1,1,0,1);
                        Log.d(log,a1sStreamId+"a1s");
                        break;
                    case "b1":b1StreamId=soundPool.play(b1Id,1,1,1,0,1);
                        Log.d(log,b1StreamId+"b1");
                        break;
                    case "c1":c1StreamId=soundPool.play(c1Id,1,1,1,0,1);
                        Log.d(log,c1StreamId+"c1");
                        break;
                    case "c1s":c1sStreamId=soundPool.play(c1sId,1,1,1,0,1);
                        Log.d(log,c1sStreamId+"c1s");
                        break;
                    case "c2":c2StreamId=soundPool.play(c2Id,1,1,1,0,1);
                        Log.d(log,c2StreamId+"c2");
                        break;
                    case "d1":d1StreamId=soundPool.play(d1Id,1,1,1,0,1);
                        Log.d(log,d1StreamId+"d1");
                        break;
                    case "d1s":d1sStreamId=soundPool.play(d1sId,1,1,1,0,1);
                        Log.d(log,d1sStreamId+"d1s");
                        break;
                    case "e1":e1StreamId=soundPool.play(e1Id,1,1,1,0,1);
                        Log.d(log,e1StreamId+"e1");
                        break;
                    case "f1":f1StreamId=soundPool.play(f1Id,1,1,1,0,1);
                        Log.d(log,f1StreamId+"f1");
                        break;
                    case "f1s":f1sStreamId=soundPool.play(f1sId,1,1,1,0,1);
                        Log.d(log,f1sStreamId+"f1s");
                        break;
                    case "g1":g1StreamId=soundPool.play(g1Id,1,1,1,0,1);
                        Log.d(log,g1StreamId+"g1");
                        break;
                    case "g1s":g1sStreamId=soundPool.play(g1sId,1,1,1,0,1);
